    ...
    <div class="blog-container">
        ...
        <div class="author-box">
            ...
            <div>
                ...
                <small>Mar 26, 2024 • 2 min read</small>
            </div>
        </div>
        <!-- Title -->
        ...
        <div class="blog-content">
            ...
            <hr>
            <p class="text-primary">Contact our Partners behind the Deal of the Year - 2023</p>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        <div class="card p-4 shadow-sm h-100 bg-light">
                            ...
                            <p class="mb-1">
                                <strong>Email:</strong>
                                <a href="" class="text-primary">anu.monga@anantlaw.com</a>
                            </p>

                            <p class="mb-1">
                                <strong>Mobile:</strong>
                                <a href="" class="text-primary">+91 98112 64474</a>
                            </p>

                            <p class="mb-0">
                                <strong>Connect:</strong>
                                <a href="https://www.linkedin.com/in/anu-monga-27457166/" target="_blank" class="text-primary">LinkedIn</a>
                            </p>
                        </div>
                    </div>
